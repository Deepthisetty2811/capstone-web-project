...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['title'])) {
    ...
    $conn->query("INSERT INTO tasks (user_id,title,description,priority,due_date,category,status)
                  VALUES ('$user_id','$title','$description','$priority','$due_date','$category','pending')");
}
